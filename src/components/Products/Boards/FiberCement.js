  ...
  return (
    <article className="product-details">
      ...
      <section className="product-section">
        ...
        <p>
          Effect of Temperature: SIG Fiber Cement Boards are not recommended to
          be stored in temperature above 500 for prolonged period.
        </p>
        <p>
          Effect of condensation: SIG Fiber Cement Boards are vapor permeable.
          If vapor condenses on the surface, the board will retain its strength.
        </p>
      </section>
